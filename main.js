...
// đảo chuỗi dùng hàm
const reverseFunc = (s) => {
  var convertStringToArray = s.split("");
  console.log(convertStringToArray);
  var stringReverse = convertStringToArray.reverse();
  console.log(stringReverse);
  var convertToString = stringReverse.join("");
  return convertToString;
};
console.log(reverseFunc("abc"));
// tìm vị trí xuất hiện phần tử chỉ định
...
// cách dùng hàm
let arr514 = [1, 3, 5, 7, 9, 11, 14, 18, 22];
console.info("Item was found at index: " + linearSearch(arr514, 22));
console.log(arr514.length - 1);
var findElementExists = (arr, x) => {
...
console.log(findElementExists(arr514, 11));
